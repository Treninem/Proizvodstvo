...
def _help_text() -> str:
    return (
        ...
        "• сохраните.\n\n"
        "Фраза «назначить должность» тоже поддерживается, когда бот получает обычные сообщения группы. "
        "Команда /role работает и при стандартном режиме приватности Telegram."
    )
