...
Отчёты
Показывает итоги за день, неделю, месяц или выбранный период. В файлах есть склад, комплектующие по датам, остатки, расчёт сборки, план до нужного количества, сборка, отправка и журнал записей.
