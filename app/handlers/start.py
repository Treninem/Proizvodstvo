...
• чего не хватает;
• сколько нужно для 10 000, 50 000, 100 000 или любого другого количества.

Если название введено неполно, бот предложит выбрать сохранённую позицию кнопкой.""",
    "work": """Ввод данных в группе

Пишите коротко: действие, название, количество.
...
План сборки: Изделие 1 10000; Изделие 2 5000
Назначить должность
